...
from webshare_app.core.update_manifest import canonical_manifest_payload
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build a signed update manifest for WebShare Pro")
